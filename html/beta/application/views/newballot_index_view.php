...
<head>
	...
	<style>
		...
		header div#headspace { padding-top: .75em; float:right; width:60%; padding-right: 1%;}
...
<div id='main'>
	...
	<?php foreach ($bills as $bill):
			if (!trim($bill['summary'])) { continue; }
			$bill['article_number'] = $bill['type'] .'.'. $bill['number'];
	?>
	<div class='bill'>
		<h2>
			<a href='/bill/<?= $bill['article_number']; ?>'><span class='billnumber'>H. <?= $bill['article_number']; ?></span> - <span class='billtitle'><?= $bill['title']; ?></a></span>
		</h2>
		<div class='billdesc'>
			<p><?= $bill['summary']; ?></p>
